...
class Trainer(vgtk.Trainer):
    ...
    def _setup_datasets(self):
        #  root="/data-input/motion_part_split_meta_info", npoints=512, split='train', nmask=10, shape_types=["03642806", "04379243"],  real_test=False,
        #             part_net_seg=False, partnet_split=False, args=None, split_types=False

        ''' set datasets and data-loaders '''
        npoints = 128
    ...
    def _optimize(self, data):
        ...
        pred, feat = self.model(in_tensors, in_pose, None)
    ...
    def eval(self):
        ...
        with torch.no_grad():
            ...
            for it, data in enumerate(self.dataset_test):
                ...
                pred, feat = self.model(in_tensors, in_pose)
