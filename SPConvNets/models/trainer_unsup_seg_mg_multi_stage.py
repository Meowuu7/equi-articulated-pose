...
class Trainer(vgtk.Trainer):
    ...
    def _setup_datasets(self):
        ...
        if self.dataset_type == DATASET_PARTNET:
            ...
            if self.dataset_type == DATASET_MOTION:
                ...
                cur_dataset = MotionDatasetPartial
    ...
    def _optimize(self, data):
        ...
        if self.local_rank == 0:
            print(pred_part_axis.size(), part_axis.size(), mean_dot_prod_val, pred_part_axis, part_axis)
    ...
    def eval(self):
        ...
        with torch.no_grad():
            ...
            for it, data in enumerate(self.dataset_test):
                ...
                print(f"dot_prod_axis_pred: {mean_dot_prod_val}")
