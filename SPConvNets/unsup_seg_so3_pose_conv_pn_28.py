    ...
    def forward_one_iter(self, x, pose, ori_pc=None, rlabel=None, cur_iter=0, gt_pose=None, gt_pose_segs=None,
        ...
        for i_s in range(self.num_slots):
            ...
            for i_bz in range(bz):
                ...
                #
                cur_bz_cur_slot_plane_x = sptk.SphericalPointCloud(safe_transpose(cur_bz_cur_slot_xyz, -1, -2), cur_bz_cur_slot_inv_feats.unsqueeze(-1).unsqueeze(1).contiguous().repeat(1, cur_bz_cur_slot_xyz.size(1), 1, 1), x.anchors[29].unsqueeze(0))
